...
/**** Database ****/
exports.kittenDB = require("./question_db")(mongoose_1.default);
/**** Configuration ****/
var app = express_1.default();
app.use(cors_1.default());
app.use(body_parser_1.default.json()); // Parse JSON from the request body
app.use(morgan_1.default("combined")); // Log all requests to the console
...
mongoose_1.default
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, exports.kittenDB.bootstrap()];
            case 1:
                _a.sent(); // Fill in test data if needed.
                app.listen(constants_1.PORT); // Start the API
                console.log("Question API running on port " + constants_1.PORT + "!");
                return [2 /*return*/];
        }
    });
}); })
